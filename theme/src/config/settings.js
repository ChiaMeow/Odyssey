export default {
	title: `Wayne's Blog | A Marketing Website Theme for Startups and Businesses`,
	...
	name: `Wayney`, // The short name of the business or brand name. Used for things like the copyright in the footer.
